...
export default async function MyOrdersPage() {
  ...
  const orders = await ordersService.findAllForCustomer(session.user.id);
      ...
      <div className="mt-6 space-y-3">
        {orders.map((o) => (
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="font-semibold text-slate-900">{o.orderNumber ?? 'Menunggu konfirmasi Marketing'}</p>
