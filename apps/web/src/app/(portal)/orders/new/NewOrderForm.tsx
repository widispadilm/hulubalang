  ...
  return (
    <div className="space-y-6">
            ...
            <div key={i} className="rounded-lg border border-slate-100 bg-slate-50 p-4">
              ...
              <div className="mt-3 grid gap-3 sm:grid-cols-3">
                ...
                <div>
                  ...
                  <input value={v.vehicleBrand} onChange={(e) => updateVehicle(i, { vehicleBrand: e.target.value })} required placeholder="Mis. Toyota" className="mt-1 w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm text-slate-900 focus:border-pss-green-500 focus:outline-none focus:ring-1 focus:ring-pss-green-500" />
                </div>
                <div>
                  <label className="block text-xs font-medium text-slate-600">Jenis/Model Mobil</label>
                  <input value={v.vehicleModel} onChange={(e) => updateVehicle(i, { vehicleModel: e.target.value })} required placeholder="Mis. Avanza" className="mt-1 w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm text-slate-900 focus:border-pss-green-500 focus:outline-none focus:ring-1 focus:ring-pss-green-500" />
                </div>
                <div>
                  <label className="block text-xs font-medium text-slate-600">Plat Nomor</label>
                  <input value={v.plateNumber} onChange={(e) => updateVehicle(i, { plateNumber: e.target.value })} required placeholder="B 1234 ABC" className="mt-1 w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm text-slate-900 focus:border-pss-green-500 focus:outline-none focus:ring-1 focus:ring-pss-green-500" />
                </div>
                <div>
                  <label className="block text-xs font-medium text-slate-600">Nomor Rangka</label>
                  <input value={v.chassisNumber} onChange={(e) => updateVehicle(i, { chassisNumber: e.target.value })} required placeholder="MHF..." className="mt-1 w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm text-slate-900 focus:border-pss-green-500 focus:outline-none focus:ring-1 focus:ring-pss-green-500" />
                </div>
                <div>
                  <label className="block text-xs font-medium text-slate-600">Nomor Mesin</label>
                  <input value={v.engineNumber} onChange={(e) => updateVehicle(i, { engineNumber: e.target.value })} required placeholder="1NR..." className="mt-1 w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm text-slate-900 focus:border-pss-green-500 focus:outline-none focus:ring-1 focus:ring-pss-green-500" />
                </div>
              </div>
            </div>
          ))}
      ...
      <button
        ...
        onClick={submit}
        disabled={pending}
        className="w-full rounded-md bg-slate-900 px-4 py-3 text-sm font-semibold text-white hover:bg-slate-800 disabled:opacity-50 sm:w-auto cursor-pointer"
      >
